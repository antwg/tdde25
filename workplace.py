...
class Workplace:
    ...
    def get_suitable_builder(self) -> Optional[Unit]:
    ...
    def get_suitable_worker_and_remove(self) -> Optional[Unit]:
    ...
    def add_mineral_field(self, mineral_field: Unit) -> None:
    ...
    def add_geyser(self, geyser: Unit) -> None:
